      ...
      children: [
        Positioned(
          ...
          child: SizedBox(
            ...
            child: Opacity(
                opacity: 0.5,
                child: Image.asset("assets/images/blob-haikei.png")),
          ),
        ),
        Positioned(
          top: 540,
          ...
          child: SizedBox(
            ...
            width: 540,
            child: Opacity(
                opacity: 0.5, child: Image.asset("assets/images/haikei.png")),
          ),
        ),
        Positioned(
          top: 0,
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "Great job so far today Abid! Lets do a little more :)",
                    style: GoogleFonts.poppins(
